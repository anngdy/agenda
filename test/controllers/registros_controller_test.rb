...
class RegistrosControllerTest < ActionController::TestCase
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post :create, registro: { date: @registro.date, endereco: @registro.endereco, horario: @registro.horario, nome: @registro.nome }
    end
  ...
  test "should update registro" do
    patch :update, id: @registro, registro: { date: @registro.date, endereco: @registro.endereco, horario: @registro.horario, nome: @registro.nome }
    assert_redirected_to registro_path(assigns(:registro))
  end
